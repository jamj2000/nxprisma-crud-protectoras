...
import { modificarProtectora } from '@/lib/actions'
import { toast } from 'sonner';



export default function ProtectoraModificar({ protectora = {} }) {
    const formId = useId()
    const [state, action, pending] = useActionState(modificarProtectora, {})
    ...
    return (
        <form id={formId} action={action} >
            ...
            <h1 className='text-orange-700 text-xl font-bold text-center'>Actualizar protectora</h1>
            ...
            <div className='text-lg mb-4 w-full grid grid-cols-1 md:grid-cols-[100px_auto] items-center gap-4 p-6 rounded-lg border-2 border-zinc-200'>
                ...
                <input
                    ...
                    id="nombre"
                    name="nombre"
                    defaultValue={protectora?.nombre}
                ...
                <input
                    ...
                    id="localidad"
                    name="localidad"
                    defaultValue={protectora.localidad}
                ...
                <input
                    ...
                    id="telefono"
                    name="telefono"
                    defaultValue={protectora.telefono}
                    className='place-self-start self-center bg-zinc-100 p-2 rounded hover:ring-1 focus:outline-none disabled:bg-zinc-400 disabled:text-zinc-200'
                    disabled={pending}
                />
